...
def train_distilbert(
    ...
    train_tokenized.set_format(type="torch", columns=["input_ids", "attention_mask", "sentiment"])
    val_tokenized.set_format(type="torch", columns=["input_ids", "attention_mask", "sentiment"])
...
def evaluate_model(
    ...
    # Set format for PyTorch
    test_tokenized.set_format(type="torch", columns=["input_ids", "attention_mask", "sentiment"])
